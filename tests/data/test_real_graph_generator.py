...
class TestRealGraphGenerator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.datasets = ['chebi20'] #,'explagraphs' ,'stack_elec','fb15k237', 're_europe','oag_scholar_interest','chebi20', 'esol', 'fingerprint', 'ogbl_vessel','movielens1m','yelp_review', 'yelp_review', 'ogbl_vessel','movielens1m', 'usa_airport', 'twitch', 'ogbn_arxiv','wikics','aminer', 'ogbn_arxiv','ogbl_vessel'
