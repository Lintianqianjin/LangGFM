...
python scripts/training.py --train_dir experiments/format_aug/${DATASET}_${FORMAT}/train_800 --eval_dir experiments/format_aug/${DATASET}_${FORMAT}/test_200 --model_name_or_path $MODEL --lora_rank 64 --lora_alpha 256 --lora_dropout 0. --use_rslora True --learning_rate 2.0e-5 --batch_size 64 --num_train_epochs 50 --warmup_ratio 0.4 --eval_steps 25 --save_steps 25
